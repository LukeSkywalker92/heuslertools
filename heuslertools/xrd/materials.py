...
NiMnSb = HalfHeuslerCubic216('Ni', 'Mn', 'Sb', 5.926, cij=CubicElasticTensor(1.709e+11, 8.27e+10, 5.47e+10))

def CuMnSb_occ(occ=[1,1,1]):
    """
    Returns a CuMnSb Material
    """
    return HalfHeuslerCubic216('Cu', 'Mn', 'Sb', 6.095, cij=CubicElasticTensor(1.056e+11, 8.27e+10, 5.47e+10), occ=occ)
