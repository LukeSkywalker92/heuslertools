...
class O2TSimulation(object):
    ...
    def simulate_o2t(self, H, K, L, qz_range, monochromator=xu.materials.Ge.planeDistance(2, 2, 0), polarization='both', I0=1000000000, background=1):
        ...
        md = xu.simpack.DynamicalModel(self.layerstack, resolution_width=self.resol,background=background, polarization=polarization, Cmono=Cmono, I0=I0)
